...
public class Prog2 {
    public static void main(String[] args) {
        ...
        String[] item = records.split(":");

        String[] str1Arr = records.split(":");

        for (String str : str1Arr) {
            String[] str2Arr = str.split(","); //Splitting the string using a delimiter "," to create an array of string separated by ","
